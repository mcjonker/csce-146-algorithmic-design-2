...
// This Linked List extends the Queue interface, and operates its queue functionality using a LinkedList structure.

public class GenLLQueue <T> implements QueueI<T> {
